...
export const AppMessagesSchema = z.object({
  ...
  Account: z.object({
    ...
    privacyBody: requiredText,
    exportData: requiredText,
    deleteAccount: requiredText,
    deleteWarning: requiredText,
    deleteConfirmLabel: requiredText,
    deleteConfirm: requiredText,
    deleteCancel: requiredText,
    deleteError: requiredText,
    exportError: requiredText,
    exporting: requiredText,
    deleting: requiredText,
  }),
  Legal: z.object({
